...
### Lesson 1: Swift Fundamentals
- Printing to console
- Variables vs Constants (`var` vs `let`)
- Data types (String, Int, Double)
- Basic arithmetic operations
- String interpolation
- Introduction to building a mini game

### Lesson 2: Logic & Control Flow
...
### Lesson 3: Collections & Functions
- Arrays (creating, accessing, and modifying)
- Array methods (`.append()`, `.remove()`, `.count`)
- Loops (`for...in`, range loops)
- Loop indexing
- Functions (defining and calling)
- Function parameters

### Lesson 4: SwiftUI Basics
...
- Grid layouts
- Data modeling with `Identifiable`
- Resource management
- Interactive buttons
